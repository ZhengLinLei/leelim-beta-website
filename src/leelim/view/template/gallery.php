<?php
    ...
    $include = (isset($_GET['album']))?'album':'index';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    ?>
    <link rel="stylesheet" href="/static/css/gallery_collection.css">
    <?php
        }else{
    ?>
    <link rel="stylesheet" href="/static/css/gallery_album.css">
    <?php
        }
    endif;
    ?>
...
<body>
    ...
    $mvc->include_modules('gallery/'.$include); //INCLUDE PGAE
