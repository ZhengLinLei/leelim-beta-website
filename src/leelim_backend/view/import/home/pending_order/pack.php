<p class="mb-4">Pedidos pendientes de <b>Empaquetar</b></p>

<div class="my-5 py-5">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Pendientes de empaquetar</h6>
            <div>
            ...
            <div class="table-responsive" style="overflow-x:hidden">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="table-layout: fixed;">
                    ...
                    <tbody>
                        ...
                        $list = $mvc->get_pending_pack_order();
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="AddItem">Completar Empaquetación del Pedido</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <p>Si terminastes de enviar el pedido puede introducir el codigo de envio y Aceptar</p>
                <div>
                    Pedido:
